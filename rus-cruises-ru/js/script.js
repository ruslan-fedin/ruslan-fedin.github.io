$(document).ready(function(){
    ...
    $('.callback-link').live('click', function(){
        $('#callback').dialog('open');
        return false;
    })
    $('#callback .callback_button').live('click', function(){
    ...
    $('.opin-link').live('click', function(){
        $('#opin').dialog('open');
        return false;
    })
    $('#opin_ok, #callback_ok, #order_ok').dialog({
        autoOpen:false,
        width:302,
        modal:true,
        resizable: false,
    ...
    $('#opin .callback_button').live('click', function(){
        $('#opin').dialog('close');
        $('#opin_ok').dialog('open');
        return false;
    })
    /*$('.box_order .submit').live('click', function(){
    ...
    $('.ui-widget-overlay').live('click', function(){
        $('#callback').dialog('close');
        $('#opin').dialog('close');
        $('#opin_ok').dialog('close');
        $('#callback_ok').dialog('close');
        $('#order_ok').dialog('close');
    })
    //grafik
